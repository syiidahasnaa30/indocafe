class Review extends HTMLElement {
  ...
  render() {
    this.innerHTML = `
      <picture>
        <source class="lazyload" type="image/webp" data-srcset="./images/user.webp" />
        <source class="lazyload" type="image/png" data-srcset="./images/user.png" />
        <img tabindex="0" class="lazyload" data-src="./images/user.png" alt="reviewer image" />
      </picture>
